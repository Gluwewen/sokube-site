...
features:
  - title: "Kubernetes expert"
    ...
    items:
      - title: "Kubernetes Certified Service Provider (KCSP)"
        text: "we are certified as a Kubernetes Certified Service Provider, recognized by the Cloud Native Computing Foundation (CNCF), the foundation that hosts Kubernetes and its ecosystem."
      - title: "CNCF Silver Member"
        text: "we are a Silver Member of the Cloud Native Computing Foundation."
  ...
  - title: "If you're asking yourself these questions about Kubernetes:"
    ...
    button_link: "/contact"
    items:
      - title: "Which distribution should I choose?"
      - title: "What architecture should I put in place?"
      - title: "On-premise vs Cloud vs Hybrid, which approach?"
      - title: "How do I provision a cluster?"
      - title: "How do I manage multiple clusters?"
      - title: "How do I secure a Kubernetes cluster?"
      - title: "How do I handle day-2 operations and manage the cluster's lifecycle?"
      - title: "What are the costs of setting up this type of infrastructure?"
      - title: "What organization needs to be put in place?"
      - title: "How do I deploy my applications in Kubernetes?"
...
faq:
  ...
  items:
    - question: "Flexibility and portability"
      answer: "Kubernetes lets you deploy applications across different environments, whether on-premise, on dedicated servers, or in the Cloud. Applications can be easily migrated from one environment to another without modification."
    - question: "Scalability"
      answer: "Kubernetes makes it easy to scale applications by dynamically managing the number of containers needed to meet user demand. Applications can be easily resized based on real-time needs."
    - question: "Availability"
      answer: "Kubernetes ensures application availability by automatically restarting containers in case of failure. Applications are fault-tolerant and can keep running even when problems occur."
    - question: "Automation"
      answer: "Kubernetes helps automate many processes, such as deployment, updates, scaling, monitoring, and so on. This reduces manual tasks and human error, and speeds up development and delivery cycles."
    - question: "Security"
      answer: "Kubernetes provides basic security features, such as role management, securing communications, isolation, and access restriction. This gives you a first level of security to protect applications and data, with the option to easily add further layers of security through third-party solutions to move towards a \"zero trust\" approach."
