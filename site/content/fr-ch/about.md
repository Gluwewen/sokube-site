...
>}}
<p>
    NeuroKube corrèle les informations provenant de Kubernetes,
    de l'Infrastructure as Code, des dépôts Git, de la documentation,
    des plateformes d'observabilité et des bases de connaissances.
</p>
<ul>
    <li>Runtime Kubernetes</li>
    <li>GitOps et code source</li>
...
>}}
<p>
    NeuroKube accompagne l'ensemble du cycle opérationnel,
    de l'alerte jusqu'à la vérification en runtime, via un seul fil conducteur traçable.
</p>
<ul>
    <li>Investigation</li>
...
>}}
<p>
    Les ingénieurs conservent le contrôle à chaque étape.
    Les recommandations peuvent être examinées, déléguées,
    modifiées ou rejetées à tout moment.
</p>
<ul>
...
>}}
<p>
    Les connaissances opérationnelles sont continuellement capturées
    et transformées en expertise réutilisable à l'échelle de l'organisation.
</p>
<ul>
    <li>Connaissance des incidents</li>
    <li>Runbooks</li>
...
{{< neurokube-callout
    ...
    secondaryButtonText="Lire le blog SoKube"
